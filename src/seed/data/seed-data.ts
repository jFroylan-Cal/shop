...
type ValidGender = 'Male' | 'Women' | 'Child' | 'Unisex';
...
export const initialData: SeedData = {
  users: [
    {
      ...
      fullName: 'test one',
      password: bcrypt.hashSync('qwert123', 10),
      roles: ['admin']
    },
    {
  ...
  products: [
    ...
    {
      description:
        'Designed for fit, comfort and style, the Childs Cybertruck Graffiti Long Sleeve Tee features a water-based Cybertruck graffiti wordmark across the chest, a Tesla wordmark down the left arm and our signature T logo on the back collar. Made from 50% cotton and 50% polyester.',
      images: ['1742694-00-A_1_2000.jpg', '1742694-00-A_3.jpg'],
      stock: 10,
      price: 30,
      sizes: ['XS', 'S', 'M'],
      slug: 'Childs_cybertruck_long_sleeve_tee',
      type: 'shirts',
      tags: ['shirt'],
      title: 'Childs Cybertruck Long Sleeve Tee',
      gender: ['Child'],
    },
    {
      description:
        'The Childs Scribble T Logo Tee is made from 100% Peruvian cotton and features a Tesla T sketched logo for every young artist to wear.',
      images: ['8529312-00-A_0_2000.jpg', '8529312-00-A_1.jpg'],
      stock: 0,
      price: 25,
      sizes: ['XS', 'S', 'M'],
      slug: 'Childs_scribble_t_logo_tee',
      type: 'shirts',
      tags: ['shirt'],
      title: 'Childs Scribble T Logo Tee',
      gender: ['Child'],
    },
    {
      description:
        'The Childs Cybertruck Tee features the iconic Cybertruck graffiti wordmark and is made from 100% Peruvian cotton for maximum comfort.',
      images: ['8529342-00-A_0_2000.jpg', '8529342-00-A_1.jpg'],
      stock: 10,
      price: 25,
      sizes: ['XS', 'S', 'M'],
      slug: 'Childs_cybertruck_tee',
      type: 'shirts',
      tags: ['shirt'],
      title: 'Childs Cybertruck Tee',
      gender: ['Child'],
    },
    {
      description:
        "The refreshed Childs Racing Stripe Tee is made from 100% Peruvian cotton, featuring a newly enhanced racing stripe with a brushed Tesla wordmark that's perfect for any speed racer.",
      images: ['8529354-00-A_0_2000.jpg', '8529354-00-A_1.jpg'],
      stock: 10,
      price: 30,
      sizes: ['XS', 'S', 'M'],
      slug: 'Childs_racing_stripe_tee',
      type: 'shirts',
      tags: ['shirt'],
      title: 'Childs Racing Stripe Tee',
      gender: ['Child'],
    },
    {
      description:
      ...
      price: 30,
      sizes: ['XS', 'S', 'M'],
      slug: 'Childs_3d_t_logo_tee',
      type: 'shirts',
      tags: ['shirt'],
      title: 'Childs 3D T Logo Tee',
      gender: ['Child'],
    },
    {
      description:
      ...
      price: 30,
      sizes: ['XS', 'S', 'M'],
      slug: 'Childs_checkered_tee',
      type: 'shirts',
      tags: ['shirt'],
      title: 'Childs Checkered Tee',
      gender: ['Child'],
    },
    {
      description:
    ...
    {
      description:
        'The Childs Scribble T Logo Onesie is made from 100% Peruvian cotton and features a Tesla T sketched logo for every little artist to wear.',
    ...
    {
      description:
        'Wear your Childs Cyberquad Bomber Jacket during your adventures on Cyberquad for Childs. The bomber jacket features a graffiti-style illustration of our Cyberquad silhouette and wordmark. With three zippered pockets and our signature T logo and Tesla wordmark printed along the sleeves, Childs Cyberquad Bomber Jacket is perfect for wherever the trail takes you. Made from 60% cotton and 40% polyester.',
      images: ['1742702-00-A_0_2000.jpg', '1742702-00-A_1.jpg'],
      stock: 10,
      price: 65,
      sizes: ['XS', 'S', 'M'],
      slug: 'Childs_cyberquad_bomber_jacket',
      type: 'shirts',
      tags: ['shirt'],
      title: 'Childs Cyberquad Bomber Jacket',
      gender: ['Child'],
    },
    {
      description:
        'Cruise the playground in style with the Childs Corp Jacket. Modeled after the original Tesla Corp Jacket, the Childs Corp Jacket features the same understated style and high-quality materials but at a pint-sized scale.',
      images: ['1506211-00-A_0_2000.jpg', '1506211-00-A_1_2000.jpg'],
      stock: 10,
      price: 30,
      sizes: ['XS', 'S', 'M'],
      slug: 'Childs_corp_jacket',
      type: 'shirts',
      tags: ['shirt'],
      title: 'Childs Corp Jacket',
      gender: ['Child'],
    },
  ],
};
